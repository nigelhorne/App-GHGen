...
# Source:  C<0> when the answer is negative (C<n> or C<no>, case-insensitive) or
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  when the empty response maps to an C<'n'> default.
# Hint:    Likely missing edge-case test (boundary value)
...
# Source:  answer ≔ chomp(readline(STDIN))
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  Display C<$question> followed by a numbered list of C<$choices>, read one
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  All available options, displayed numbered from 1.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  python => \&_customize_python,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
