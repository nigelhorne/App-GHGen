...
# --- SURVIVOR: COND_INV_54_2 (MEDIUM) line 54 ---
# Source:  has_dist_ini   => Bool,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_54_2 line 54';
    ...
    # TODO: exercise line 54 to detect the mutant
    fail('COND_INV_54_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_56_3 (MEDIUM) line 56 ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_56_3 line 56';
    # NOTE: App::GHGen::PerlCustomizer has no constructor — call class methods directly.
    # e.g. my $result = App::GHGen::PerlCustomizer->method(...);
    # TODO: exercise line 56 to detect the mutant
    fail('COND_INV_56_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_61_2 (MEDIUM) line 61 ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_61_2 line 61';
    # NOTE: App::GHGen::PerlCustomizer has no constructor — call class methods directly.
    # e.g. my $result = App::GHGen::PerlCustomizer->method(...);
    # TODO: exercise line 61 to detect the mutant
    fail('COND_INV_61_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_63_3 (MEDIUM) line 63 ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_63_3 line 63';
    # NOTE: App::GHGen::PerlCustomizer has no constructor — call class methods directly.
    # e.g. my $result = App::GHGen::PerlCustomizer->method(...);
    # TODO: exercise line 63 to detect the mutant
...
# --- SURVIVOR: NUM_BOUNDARY_374_57_< (HIGH) line 374 in generate_custom_perl_workflow() ---
# Source:  $yaml .= "          \@echo off\n";
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (7 variants — one test should kill all):
#   Numeric boundary flip <= to <
#   Numeric boundary flip <= to >
...
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_374_57_< line 374 in generate_custom_perl_workflow()';
    # NOTE: App::GHGen::PerlCustomizer has no constructor — call class methods directly.
    # e.g. my $result = App::GHGen::PerlCustomizer->method(...);
    # TODO: exercise line 374 in generate_custom_perl_workflow() to detect the mutant
    fail('NUM_BOUNDARY_374_57_<: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_386_2 (MEDIUM) line 386 in generate_custom_perl_workflow() ---
# Source:  use File::Find;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_386_2 line 386 in generate_custom_perl_workflow()';
    # NOTE: App::GHGen::PerlCustomizer has no constructor — call class methods directly.
    # e.g. my $result = App::GHGen::PerlCustomizer->method(...);
    # TODO: exercise line 386 in generate_custom_perl_workflow() to detect the mutant
    fail('BOOL_NEGATE_386_2: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_386_2 line 386 in generate_custom_perl_workflow() ---
# Source:  use File::Find;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
